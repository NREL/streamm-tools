...
def convert_angstroms_nm(d_ang):
    """
    convert nm to angstroms
    """
    return d_ang/nm_angstroms
...
def convert_kb_g_angle(g_ka):
    """
    convert general angle parameter defined by lammps
        kcal/mol /radina^2
    to to gromacs harmonic angle parameter in
        1/2.0 K kJ/mol/radina^2
    """
    return g_ka/kJmol_kcalmol*2.0


def convert_fs_ns(t_fs):
    """
    convert to ns
    from fs
    """
