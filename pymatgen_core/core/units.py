...
'''
.. ChangeLog::
* Add nm to length units
* Remove Amp from base units and Coulomb instead
* Add ns to time
* Create a units_conf dictionary to store default units 
* Add speed of light in vacuum for statcoulomb conversion
...
speed_of_light = const.physical_constants['speed of light in vacuum'][0]
...
DERIVED_UNITS = {
    ...
    "density":{
        ...
        'g_cm^3':{"g": 1, "cm": -3},
        'amu_nm^3':{"amu": 1, "nm": -3},
        'amu_ang^3':{"amu": 1, "ang": -3},
        },
    "current": {
        "A":{'C':1,'s':-1}
    },
    "electric_dipole_moment":{
        'coulomb-meter':{'C':1,'m':1},
        'D':{'statC':1,'cm':1},
        },
    "energy": {
    ...
    "emf": {
        "V": {"m": 2, "kg": 1, "s": -3, "C": 1,'s':-1}
    },
    "capacitance": {
        "F": {"m": -2, "kg": -1, "s": 4, "C": 2,'s':-2}
    },
    "resistance": {
        "ohm": {"m": 2, "kg": 1, "s": -3, "C": -2,'s':2}
    },
    "conductance": {
        "S": {"m": -2, "kg": -1, "s": 3, "C": 2,'s':-2}
    },
    "magnetic_flux": {
