...
class TestBBatom(unittest.TestCase):
    def setUp(self):
	self.particle_i = buildingblock.BBatom("C")

    def test_name(self):
        self.assertEqual(str(self.particle_i)," C ")
...
class TestBuildThiophene(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Th = buildingblock.Container('thiophene')
...
class TestBuildHexane(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Hx = buildingblock.Container('hexane')
...
class TestContainer(unittest.TestCase):
    def setUp(self):
        self.bblockC = buildingblock.Container()
        self.bblockC2 = buildingblock.Container()
...
class TestJoin(unittest.TestCase):
    def setUp(self):
        self.bblockC_i = buildingblock.Container()
        self.bblockC_j = buildingblock.Container()
        self.bblockC_p3htnX = buildingblock.Container()
        cply_file = os.path.join(os.path.dirname(__file__), 'thiophene.cply')
        ...
        self.th_v2 = buildingblock.Container()
...
class Testattachprep(unittest.TestCase):
    def setUp(self):
        ...
        self.Th2 = buildingblock.Container('Th2')
        cply_file = os.path.join(os.path.dirname(__file__), 'thiophene.cply')
...
class TestP3HT(unittest.TestCase):
    def setUp(self):
        ...
        # Read in thiophene building block 
        self.bb_thiophene = buildingblock.Container()
        cply_file = os.path.join(os.path.dirname(__file__), 'thiophene.cply')
        self.bb_thiophene.read_cply(cply_file)        

        # Read in hexane building block 
        self.bb_R_hexane = buildingblock.Container()
        cply_file = os.path.join(os.path.dirname(__file__), 'hexane.cply')
        ...
        xN = 5
        #self.bb_p3ht_nX = buildingblock.Container()
    ...
    def test_add_struc(self):
        ...
        self.bb_p3ht_n10_x10 = buildingblock.Container()
