...
p4 = Particle( [0.0, 2.3, -20.1], "Si",  2.0, 1.23)
tagsD = {"molnum":2,"ringnum":4}
p4.setTagsDict(tagsD)

p6 = Particle( [8.0, 2.3, -20.1], "Si",  2.0, 1.23)
...
p5 = Particle( [1.0, 2.3, -20.1], "C",  1.0, 2.34)
...
typeInfo = atoms1.getTypeInfoDict()
print " "
print "type (index, mass, charge) = ", typeInfo

paramMap = {("Si", "epsilon"):2.30, ("Si", "sigma"):1.0, ("C", "epsilon"):0.5, ("C", "sigma"): 0.1 }

atoms1.setTypeParams(paramMap)
print atoms1

pm = atoms1.getTypeParams()
print "pm = ", pm
print "types ", pm.keys()

for paramTuple, paramVal in pm.iteritems():
    if 'Si' and 'epsilon' in paramTuple:
        print paramTuple, " ", paramVal
