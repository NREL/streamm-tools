...
python com2gromacs.py --in_com ${MOLDIR}${MOLID}.com  --out_gro ${MOLDIR}${MOLID}.gro --in_itp conj.itp --out_itp ${MOLDIR}${MOLID}.itp --out_top ${MOLDIR}${MOLID}.top 
python com2data.py --in_com ${MOLDIR}${MOLID}.com  --out_data ${MOLDIR}${MOLID}.data
