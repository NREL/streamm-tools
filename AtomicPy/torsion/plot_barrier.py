		...
		if(  json_success ):
			...
			if( qmtor_found ):
				...
				if( success ):		    
				    ...
				    b_dat.write("\n # %d %d %s %s %s  %s %s " % ( n_units , d_pos, min_angles,min_enval, max_angles, max_enval , qm_bar ) )
				    b_dat.write("\n  %d %d %f %f %f %f " % ( n_units , d_pos, glb_min_angle,glb_min_en, glb_max_angle, glb_max_en ) )
				    b_dat.close()
